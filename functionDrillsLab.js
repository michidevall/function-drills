...
/*
  ...
  greeting should log the snodetring "Hello, "
...
//CODE HERE
// function greeting (personName) {c
...
//   } else {
//     console.log("You need to evaluate you favorite color choice");
//   }
...
//CODE HERE
// let champions = theEliminator(contestants)
// function theEliminator(arr, str) {
//   for (let i = 0; i < arr.length; i++){
//     if (arr[i] === loser) {
//      let champions = contestants.splice(i, 1)
